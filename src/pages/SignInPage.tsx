  ...
  return (
    <div className="min-h-screen bg-[#F3F5F8] flex flex-col justify-between font-sans selection:bg-red-100 selection:text-[#EC111A] antialiased">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-12">
        ...
        {/* Main White Card */}
        <div className="w-full max-w-[460px] min-h-[580px] sm:min-h-[640px] bg-white rounded-xl border border-gray-200/90 shadow-2xs py-10 sm:py-14 px-5 sm:px-10 relative flex flex-col justify-between">
          
          {/* Lock Icon in Top Right of Card */}
          <div className="absolute top-6 right-6">
            <div className="w-5 h-5 border border-gray-400/80 rounded flex items-center justify-center bg-white">
              <Lock className="w-3 h-3 text-gray-700 stroke-[2.2]" />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="text-center mb-6 pt-2">
              <h2 className="text-xl sm:text-2xl font-extrabold text-[#222222] tracking-tight mb-1.5">
                Welcome to
              </h2>
              <div className="flex items-center justify-center">
                ...
                >
                  <svg
                    ...
                    role="img"
                    aria-hidden="false"
                    className="w-[190px] sm:w-[210px] h-auto fill-[#EC111A]"
              ...
              <form onSubmit={handleSubmit} className="w-full max-w-[270px] mx-auto space-y-5">
                ...
                <div>
                  ...
                  <div className="relative flex items-center border-b border-gray-300 focus-within:border-[#006699] py-1.5 transition-colors">
                    <User className="w-4 h-4 text-gray-600 mr-2.5 shrink-0" />
                    <input
                      type="text"
                ...
                <div>
                  ...
                  <div className="relative flex items-center border-b border-gray-300 focus-within:border-[#006699] py-1.5 transition-colors">
                    <Lock className="w-4 h-4 text-gray-600 mr-2.5 shrink-0" />
                    <input
                      type={showPassword ? 'text' : 'password'}
                      placeholder="Enter password"
                      value={password}
                      onChange={(e) => setPassword(e.target.value)}
                      className="w-full text-xs sm:text-sm text-[#222222] placeholder-gray-400 bg-transparent focus:outline-none pr-7"
                    />
                    <button
                      type="button"
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-[#EC111A] hover:bg-[#C40912] disabled:opacity-60 disabled:cursor-not-allowed text-white font-bold text-xs sm:text-sm py-3 rounded-md shadow-2xs transition duration-200 mt-2 flex items-center justify-center space-x-2"
                >
                  {loading ? (
                    <>
          ...
          {/* Need help link at bottom of card */}
          <div className="text-center pt-4">
            <a href="#" className="inline-flex items-center text-xs font-bold text-[#006699] hover:underline">
