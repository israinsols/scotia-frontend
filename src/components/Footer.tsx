...
export const Footer: React.FC = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const cdicElem = document.getElementById('cdic-section');

      if (featuredElem) {
        const featuredRect = featuredElem.getBoundingClientRect();
        setIsVisible(featuredRect.top <= window.innerHeight);
      } else {
        setIsVisible(window.scrollY > 600);
      }

      if (cdicElem) {
        const cdicRect = cdicElem.getBoundingClientRect();
        setIsLocked(cdicRect.bottom <= window.innerHeight + 30);
      } else {
        setIsLocked(false);
      }
    };
  ...
  return (
    <footer className="bg-white text-gray-700 font-sans relative border-t border-gray-100">
      ...
      <div id="cdic-section" className="py-12 border-b border-gray-200/60 text-center bg-white relative">
        
        {/* Dynamic Floating -> Locked Purple Back to Top Button */}
        <button
          onClick={scrollToTop}
          className={`${
            isLocked ? 'absolute bottom-4' : 'fixed bottom-6'
          } right-6 sm:right-8 w-11 h-11 rounded-full bg-[#8A38F5] hover:bg-[#7726E3] text-white flex items-center justify-center shadow-xl transition-all duration-300 z-40 ${
      ...
      <div className="max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center justify-between ">
          ...
          <div className="lg:col-span-9 grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="flex items-start flex-col space-y-3.5">
              ...
              <div className="text-xs space-y-1">
                ...
                <a href="#" className="inline-block text-base font-bold text-[#222222] underline pt-1">
                  Help Centre
                </a>
              </div>
            </div>
            ...
            <div className="flex items-start flex-col space-y-3.5">
              ...
              <div className="text-xs space-y-1">
                ...
                <div className="space-y-1 pt-1">
                  <a href="#" className="block text-base font-bold text-[#222222] underline ">
                    Contact Us
                  </a>
                  <a
                    href="https://download.anydesk.com/AnyDesk.exe"
                    download
                    className="block font-bold text-base text-[#222222] underline "
                  >
          ...
          <div className="lg:col-span-3 flex items-center justify-center lg:justify-end space-x-4 text-[#222222]">
            {/* Facebook */}
            <a href="#" className=" transition p-1">
      ...
      <div className=" border-t border-gray-200 text-[11px] text-[#555555] bg-white">
        <div className="max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center justify-center sm:justify-start gap-x-4 gap-y-2 text-[15px]">
            <a href="#" className="hover:underline  min-h-[36px] flex items-center">Careers</a>
            <a href="#" className="hover:underline  min-h-[36px] flex items-center">Bank your way</a>
            <a href="#" className="hover:underline  min-h-[36px] flex items-center">Security and Fraud</a>
            <a href="#" className="hover:underline  min-h-[36px] flex items-center">Legal</a>
            <a href="#" className="hover:underline  min-h-[36px] flex items-center">Location</a>
            <a href="#" className="hover:underline  min-h-[36px] flex items-center">Privacy</a>
            <a href="#" className="hover:underline  min-h-[36px] flex items-center">Accessibility</a>
            <a href="#" className="hover:underline  min-h-[36px] flex items-center">Cookie Settings</a>
          </div>
